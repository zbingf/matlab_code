...
% Last Modified by GUIDE v2.5 23-May-2015 20:07:34
...
if get(hObject,'Value')
    ...
    e7=str2double(get(handles.e7,'string'));l7=str2double(get(handles.l7,'string'));t7=str2double(get(handles.t7,'string'));
    t8=str2double(get(handles.t8,'string'));l8=str2double(get(handles.l8,'string'));x9=str2double(get(handles.x9,'string'));
    y9=str2double(get(handles.y9,'string'));z9=str2double(get(handles.z9,'string'));
    ...
    AA=[H, SR, T4, Z3, Z2, Y1, Y4, ...
     ...
     IN, CA, toe, camber, L,...
     e7,l7,t7,t8,l8,x9,y9,z9]';
    xlswrite(dizhi,AA,'B1:B47');
end
...
if get(hObject,'Value')
    ...
    [H, SR, T4, Z3, Z2, Y1, Y4, ...
     ...
     AA(40),AA(41),AA(42),AA(43),AA(44),AA(45),AA(46),AA(47));
    ...
    set(handles.e7,'string',e7);set(handles.l7,'string',l7);set(handles.t7,'string',t7);
    set(handles.t8,'string',t8);set(handles.l8,'string',l8);set(handles.x9,'string',x9);
    set(handles.y9,'string',y9);set(handles.z9,'string',z9);
end
