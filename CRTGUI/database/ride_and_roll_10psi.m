...
zRR=60;%mm 后侧倾中心60mm
hUSF=228.6;%mm 前簧下质心高
hUSR=228.6;%mm 后簧下质心高
%>>>>>>>>>单轴簧下质量>>>>>>
...
KTF=86.2789;%轮胎垂向刚度 N/mm  86.2789 2015.4.15改
...
KTR=86.2789;%轮胎垂向刚度 N/mm  86.2789 2015.4.15改 (10psi 86.2789N/mm 493lb/in)
...
%>>>>>>>>>>>>>后悬U-Bar>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
KBR=3906.9;% N*mm/deg 后U-BAr扭杆弹簧刚度 2015/7/3
...
%>>>>>>>>>>>>>前悬U-Bar>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
KBF=3906.9;% N*mm/deg 前U-BAr扭杆弹簧刚度 4420
